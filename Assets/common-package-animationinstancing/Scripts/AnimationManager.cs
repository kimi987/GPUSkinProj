...
namespace AnimationInstancing
{
    public class AnimationManager : AnimationInstancingSingleton<AnimationManager>
    {
        ...
        {
            return AnimationInstancingSingleton<AnimationManager>.Instance;
        }
        ...
        public InstanceAnimationInfo FindAnimationInfoByAssetManager(GameObject prefab)
        {
            var asset = Resources.Load($"{prefab.name}", typeof(TextAsset));
            var txt = asset as TextAsset;
            var bytes = txt.bytes;
            ...
            m_animationInfo.TryAdd(prefab, info);
